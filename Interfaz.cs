    ...
    public partial class Interfaz : Form
    {
        ...
        private void btnCalculate_Click(object? sender, EventArgs e)
        {
            try
            {
                ...
                // Llamada al método de cálculo de Fibonacci
                int fibonacci = FibonacciCalculadora.Calcular(number);
                lblResult.Text = $"El número Fibonacci para {number} es {fibonacci}";
            }
        ...
        private void InitializeComponent()
        {
            ...
            this.btnCalculate.Text = "Calcular Fibonacci";
            ...
            this.Name = "Interfaz";
            this.Text = "Calculadora de Fibonacci";
